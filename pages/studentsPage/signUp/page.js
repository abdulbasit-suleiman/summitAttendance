...
function SignUp() {
  ...
  const handleSignUp = async (e) => {
    ...
    if (email.trim() === '') {
      ...
      matricNoErrorRef.current = 'Please enter your matricNo .';
      hasErrors = true;
    } if (college.trim() === '') {
    ...
    const matricNoSnapshot = await firestore.collection('users').where('matricNo', '==', matricNo).get();
    if (!matricNoSnapshot.empty) {
      matricNoErrorRef.current = 'Matric number already exists.';
      hasErrors = true;
    }
    ...
    <div className="signUp">
      ...
      <div className="signUpForm">
        ...
        <form onSubmit={handleSignUp}>
          ...
          <input type="email" value={email} onChange={handleChange} placeholder="Enter school Email" name="email" />
          ...
          <input type="text" value={matricNo} onChange={handleChange} placeholder="Enter MatricNo" name="matricNo" />
